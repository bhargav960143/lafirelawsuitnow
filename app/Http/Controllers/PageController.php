...
class PageController extends Controller
{
    ...
    {
        $data['meta_title'] = 'Los Angeles Fire Lawsuit | Get Compensation for Wildfire Damages';
        $data['meta_description'] = 'If you’ve suffered property damage, injuries, or financial losses due to a Los Angeles wildfire, you may be entitled to compensation. Get a free case evaluation today. No fees unless you win.';
        return view('home');
    }
    ...
    public function losAngelesPrivacyRights()
    {
        $data['meta_title'] = 'Los Angeles Privacy Rights';
        $data['meta_description'] = 'Los Angeles Privacy Rights';
        return view('los-angeles-privacy-and-policy');
    }
